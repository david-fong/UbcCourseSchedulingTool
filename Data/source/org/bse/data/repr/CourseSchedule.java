...
public abstract class CourseSchedule {
    ...
    public final CourseSchedule createImmutableCopy() {
        // Since [CourseSection]s are immutable, a shallow copy is sufficient:
        return new ImmutableCourseSchedule(getCourseSections());
    }



    static class ImmutableCourseSchedule extends CourseSchedule {

        private Set<Course.CourseSection> courseSections;

        private ImmutableCourseSchedule(Set<Course.CourseSection> courseSections) {
